...
// FILE_FS_DEVICE_INFORMATION characteristics bits (ntddk).
constexpr uint32_t X_FILE_REMOVABLE_MEDIA = 0x00000001;
constexpr uint32_t X_FILE_READ_ONLY_DEVICE = 0x00000002;
